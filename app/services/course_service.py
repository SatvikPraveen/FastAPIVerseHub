...
class CourseService:
    ...
    async def get_courses(
        ...
        is_published_filter: bool | None = None,
    ...
    async def unenroll_user(self, course_id: int, user_id: int) -> None:
        ...
        query = (
            update(Enrollment)
            .where(and_(Enrollment.course_id == course_id, Enrollment.user_id == user_id))
    ...
    async def get_course_enrollments(
        ...
        count_query = select(func.count(Enrollment.id)).where(Enrollment.course_id == course_id)
