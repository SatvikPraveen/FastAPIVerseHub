...
class FileManager:
    ...
    async def create_thumbnail(
        self, image_path: str, thumbnail_size: tuple = (150, 150), quality: int = 85
    ) -> str | None:
    ...
    async def get_file_metadata(self, file_path: str) -> dict[str, any]:
        ...
        metadata = {"basic_info": info, "file_type": self._get_file_type(file_path)}
    ...
    async def optimize_image(
        self, image_path: str, max_width: int = 1920, max_height: int = 1080, quality: int = 85
    ) -> str:
