...
async def upload_file(
    ...
    category: str | None = Form("general"),
...
async def list_files(
    ...
    files, total = await file_service.get_user_files(
        user_id=current_user.id, skip=skip, limit=limit, category=category
    )
...
async def download_file(
    ...
    if not await asyncio.to_thread(os.path.isfile, file_record.file_path):
