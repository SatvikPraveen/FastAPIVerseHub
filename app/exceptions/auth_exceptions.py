...
class InvalidTokenException(UnauthorizedException):
    ...
    def __init__(
        self, message: str = "Invalid or malformed token", details: dict[str, Any] | None = None
    ):
        super().__init__(message=message, error_code="INVALID_TOKEN", details=details)
...
class TokenRevokedException(UnauthorizedException):
    ...
    def __init__(
        self, message: str = "Token has been revoked", details: dict[str, Any] | None = None
    ):
...
class InvalidMFATokenException(UnauthorizedException):
    ...
    def __init__(self, message: str = "Invalid MFA token", details: dict[str, Any] | None = None):
        super().__init__(message=message, error_code="INVALID_MFA_TOKEN", details=details)
...
class MFANotSetupException(BadRequestException):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_code="MFA_NOT_SETUP", details=details)
...
class AccountDisabledException(ForbiddenException):
    ...
    def __init__(
        self, message: str = "Account has been disabled", details: dict[str, Any] | None = None
    ):
        super().__init__(message=message, error_code="ACCOUNT_DISABLED", details=details)
...
class AccountNotVerifiedException(ForbiddenException):
    ...
    def __init__(
        self, message: str = "Account email is not verified", details: dict[str, Any] | None = None
    ):
        super().__init__(message=message, error_code="ACCOUNT_NOT_VERIFIED", details=details)
...
class PasswordTooWeakException(BadRequestException):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_code="PASSWORD_TOO_WEAK", details=details)
...
class PasswordRecentlyUsedException(BadRequestException):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_code="PASSWORD_RECENTLY_USED", details=details)
...
class TooManyLoginAttemptsException(ForbiddenException):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_code="TOO_MANY_LOGIN_ATTEMPTS", details=details)
...
class InvalidResetTokenException(BadRequestException):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_code="INVALID_RESET_TOKEN", details=details)
...
class DeviceNotTrustedException(ForbiddenException):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_code="DEVICE_NOT_TRUSTED", details=details)
...
class SessionExpiredException(UnauthorizedException):
    ...
    def __init__(self, message: str = "Session has expired", details: dict[str, Any] | None = None):
        super().__init__(message=message, error_code="SESSION_EXPIRED", details=details)
...
class InvalidAPIKeyException(UnauthorizedException):
    ...
    def __init__(self, message: str = "Invalid API key", details: dict[str, Any] | None = None):
        super().__init__(message=message, error_code="INVALID_API_KEY", details=details)


class APIKeyExpiredException(UnauthorizedException):
    """Exception for expired API keys."""

    def __init__(self, message: str = "API key has expired", details: dict[str, Any] | None = None):
        super().__init__(message=message, error_code="API_KEY_EXPIRED", details=details)
