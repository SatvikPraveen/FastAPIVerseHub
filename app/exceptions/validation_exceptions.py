...
from app.exceptions.base_exceptions import UnprocessableEntityException
...
class InvalidEmailException(FieldValidationException):
    ...
    def __init__(self, email: str, field: str = "email", message: str = "Invalid email format"):
        super().__init__(field=field, message=message, value=email)


class InvalidURLException(FieldValidationException):
    """Exception for invalid URLs."""

    def __init__(self, url: str, field: str = "url", message: str = "Invalid URL format"):
        super().__init__(field=field, message=message, value=url)
...
class InvalidPhoneException(FieldValidationException):
    ...
    def __init__(
        self, phone: str, field: str = "phone", message: str = "Invalid phone number format"
    ):
        super().__init__(field=field, message=message, value=phone)
...
class StringLengthException(FieldValidationException):
    ...
    def __init__(
        self, field: str, value: str, min_length: int | None = None, max_length: int | None = None
    ):
        ...
        super().__init__(field=field, message=message, value=value, details=details)
...
class NumericRangeException(FieldValidationException):
    ...
    def __init__(
        ...
        details = {"current_value": value, "min_value": min_value, "max_value": max_value}
...
class InvalidChoiceException(FieldValidationException):
    ...
    def __init__(self, field: str, value: Any, valid_choices: list[Any]):
        ...
        details = {"valid_choices": valid_choices, "choice_count": len(valid_choices)}
...
class DateValidationException(FieldValidationException):
    ...
    def __init__(self, field: str, value: str, message: str = "Invalid date format"):
        super().__init__(field=field, message=message, value=value)
...
class FileSizeException(FileValidationException):
    ...
    def __init__(self, filename: str, file_size: int, max_size: int):
        ...
        super().__init__(
            message=message, filename=filename, file_size=file_size, details={"max_size": max_size}
        )
...
class FileTypeException(FileValidationException):
    ...
    def __init__(self, filename: str, file_extension: str, allowed_extensions: list[str]):
...
class ContentValidationException(ValidationException):
    ...
    def __init__(self, content_type: str, message: str, details: dict[str, Any] | None = None):
        if details is None:
            details = {}
...
class ProfanityException(ContentValidationException):
    ...
    def __init__(
        self, field: str = "content", message: str = "Content contains inappropriate language"
    ):
        super().__init__(content_type="text", message=message, details={"field": field})
...
class SpamException(ContentValidationException):
    ...
    def __init__(
        ...
        super().__init__(content_type="text", message=message, details=details)
...
class DuplicateValueException(ValidationException):
    ...
    def __init__(self, field: str, value: Any, message: str | None = None):
        ...
        super().__init__(message=message, field=field, value=value, error_code="DUPLICATE_VALUE")
...
class CrossFieldValidationException(ValidationException):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_code="CROSS_FIELD_VALIDATION", details=details)
