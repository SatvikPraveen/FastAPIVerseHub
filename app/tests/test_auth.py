...
class TestUserRegistration:
    ...
    async def test_register_user_duplicate_email(
        self, async_client: AsyncClient, sample_user_data, test_user: User
    ):
...
class TestUserLogin:
    ...
    async def test_login_inactive_user(self, async_client: AsyncClient, db_session: AsyncSession):
        ...
        login_data = {"email": inactive_user.email, "password": "FactoryPassword123!"}
...
class TestPasswordOperations:
    ...
    async def test_reset_password_success(self, async_client: AsyncClient, test_user: User):
        ...
        response = await async_client.post(
            ...
            json={"token": reset_token, "new_password": "ResetPassword123!"},
        )
    ...
    async def test_reset_password_invalid_token(self, async_client: AsyncClient):
        ...
        response = await async_client.post(
            "/api/v1/auth/reset-password",
            json={"token": "invalid_token", "new_password": "ResetPassword123!"},
        )
